...
export default function SidebarHomeowner({ isOpen = false, onClose }) {
  ...
  return (
    <>
      ...
      <aside className={`fixed top-0 left-0 z-50 transition-transform duration-300 h-screen ${expanded ? "h-screen w-64" : "w-20"} ${isOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`}>
<nav className={`flex flex-col bg-[var(--brand)] h-screen`}>
